    ...
    private static AnkiSettings ToAnkiSettings(this AnkiSettingsSection section)
    {
        var ankiDeckSettings = section
            .SelectMany(deckSection => deckSection
                .ThrowIfNull()
                .ToAnkiDeckSettingsRecursive(new()))
            .ToList();
